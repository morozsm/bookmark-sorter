...
def test_propose_includes_duplicates_and_normalized_updates():
    orig = [
        Bookmark(id="1", title="A", url="https://ex.com/a?id=1"),
        Bookmark(id="2", title="A", url="https://ex.com/a?id=1"),
    ]
    ...
    kept = [
        Bookmark(
            id="1",
            title="A",
            url="https://www.ex.com/a?id=1",
            normalized_url="https://ex.com/a?id=1",
        )
    ]
